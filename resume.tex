...
\textbf{\runsubsection{Personal Cloud & Homelab Infrastructure |}}
\location{Self-Hosted Services & Automation}
\begin{tightemize}
    \item Designed and manage a hybrid infrastructure using Proxmox VE on local servers (India) and a DigitalOcean VM as a secure reverse proxy; administer Linux VMs and Docker containers across environments.
    \item Deploy and maintain various self-hosted services via Docker, including a photo library, password manager, and Home Assistant for comprehensive smart home automation.
    \item Automated macOS environment setup using Ansible playbooks and implemented Grafana/Prometheus dashboards for real-time monitoring of the hybrid infrastructure.
    \item Configured secure VPN tunneling (WireGuard/OpenVPN) for remote access/linking infrastructure and actively deploying a Kubernetes (k8s) cluster for learning container orchestration.
\end{tightemize}
\sectionsep
