...
\section{Experience}
\textbf{\href{https://www.gojek.io/}{\runsubsection{Founding Mobile Engineer|}}} 
\descript{Barkie AI \datetext{June '25 – Oct '25}}
\begin{tightemize}
\item Architected and built the company’s flagship iOS application from the ground up, establishing a scalable foundation for future product development.
\item Engineered an on-device AI vision model using \emphitalic{CoreML} to scan and parse golf scorecards, automating GHIN submissions and eliminating manual data entry.
\item Collaborated with backend and design teams to implement secure authentication and deliver a polished UI/UX compliant with Apple’s \emphitalic{Human Interface Guidelines (HIG)}.
\end{tightemize}
