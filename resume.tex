...
\begin{tightemize}
    ...
    \item Architected Pin-based Auth SDK in \emphitalic{Swift} using \emphitalic{VIPER}, enabling a unified experience across GoTo apps
...
\begin{tightemize}
    ...
    \item Deep-dived into \emphitalic{legacy Objective-C} codebase with manual memory management to fix bugs and implement features.
...
\section{Skills}
\descript{Swift, SwiftUI, UIKit, Objective-C, CoreML, WidgetKit, VIPER, MVVM, Flutter, CI/CD, Server-Driven UI}
